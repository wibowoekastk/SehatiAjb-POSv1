        ...
        <form action="" method="post" class="form-horizontal">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <!-- ================================================================== -->
                    <!-- PENAMBAHAN INPUT FIELD UNTUK KADAR DAN GRAM -->
                    <!-- ================================================================== -->
                    <div class="form-group row">
                        <label for="kadar" class="col-lg-2 col-lg-offset-1 control-label">Kadar</label>
                        <div class="col-lg-6">
                            <select name="kadar" id="kadar" class="form-control" required>
                    ...
                    <div class="form-group row">
                        <label for="gram" class="col-lg-2 col-lg-offset-1 control-label">Berat (gram)</label>
                        <div class="col-lg-6">
                            <input type="number" name="gram" id="gram" class="form-control" step="0.001" required placeholder="Contoh: 5.250">
                            <span class="help-block with-errors"></span>
                        </div>
                    </div>
                    <!-- ================================================================== -->
