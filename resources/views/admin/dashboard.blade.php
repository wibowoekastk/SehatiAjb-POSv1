...
<style>
    .small-box {
        /* Mengatur tingkat kelengkungan sudut */
        border-radius: 15px;
        /* Memastikan konten di dalam tidak keluar dari batas radius */
        overflow: hidden;
    }
</style>
...
<div class="row">
    ...
    <div class="col-lg-12">
        {{-- Menambahkan style="margin-top: 0;" untuk memastikan tidak ada jarak atas --}}
